...
bool CalQuaternion::operator==(const CalQuaternion &v)
{
...
bool CalQuaternion::operator!=(const CalQuaternion &v)
{
 ...
 /*****************************************************************************/
/** Matrix to Quaternion Conversion Constructor.
  *
  * This function converts a rotation matrix into a quaternion.
  *****************************************************************************/

CalQuaternion::CalQuaternion(const CalMatrix& m)
{
  *this = m;
}
...
void CalQuaternion::operator=(const CalMatrix & m)
{
...
void CalQuaternion::blendRadians(float rad, const CalQuaternion& q)
{
 ...
 /*****************************************************************************/
/** Clears the quaternion to a null state.
  *
  * This function clears the quaternion to a null state.
  *
  *****************************************************************************/
